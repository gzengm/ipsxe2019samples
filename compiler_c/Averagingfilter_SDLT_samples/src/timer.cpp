...
// Linux*/macOS* uses the rdtsc instruction for clock ticks and get_timeofday for time
void CUtilTimer::start() {
	...
	// Clock ticks
	// On Linux and macOS, rdtsc instruction is used since we don't have intrinsic equivalent of __rdtsc()
